...
<%@ page import="com.yzh.oa.global.Contant" %>
            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-5">${item.comment}</div><br/>
                        </C:forEach>
                    </div>
                    <div class="section row">
                    ...
                    <c:forEach items="${records}" var="record">
                        ...
                        <div class="col-md-5">备注：${record.comment}</div><br/>
                    </c:forEach>
                    </div>
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.employee.post=='总经理' || sessionScope.employee.post=='部门经理'}">
